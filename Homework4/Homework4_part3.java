...
public class Homework4_part3 {
    ...
    static class LinkedListBST {
        ...
        public void insert(String city){root = insert(city, root);


        }
        public void delete(String city){root = insert(city, root);
        ...
        private Node insert(String s, Node t) {
            ...
            int cmp = s.compareTo(t.city);
            int cmp1 = s.compareTo(t.left.city);
            int cmp2 = s.compareTo(t.right.city);
             if  (cmp<0) {
        ...
        private Node delete(Node x, String city) {
            if (x == null) return null;
            int cmp =city.compareTo(x.city);
            if      (cmp < 0) x.left  = delete(x.left,  city);
            else if (cmp > 0) x.right = delete(x.right, city);
            else {
                if (x.right == null) return x.left;
                if (x.left  == null) return x.right;
                Node t = x;
